======================Readme for SURFGEN2 (for studying overdensity) ===========================================
...
rho_th (double): the isodensity (threshold value). SURFGEN2 will construct the surface using rho=rho_th (any scaler field in general). This code will study the individual overdensity regions (separated surfaces).
