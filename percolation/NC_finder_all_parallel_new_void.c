...
//mpicc -o r1.out NC_finder_all_parallel_new_void.c -lm
...
char fout[300]="void.dat";// output file
//======================================================================================================
...
double void_func(double x){return rho_0/(1.0+x);}
...
//char fout[300]="9thMay_void_NCvsRhoth_z7_5_400.dat";
...
int main ( int argc, char *argv[] )
{
  ...
  if(my_id == last_id)
  {
  	...
  	while(all_done==false)
	{
		...
		last_rh_th=last_rh_th+rho_increment;
  ...
  else
  {
  	...
  	while(rho_th>=0)
  	{
  		...
  		rho_th_void=void_func(rho_th);
  		NC = DriveClusterFinder(cluster, rho_th_void, &ff);
